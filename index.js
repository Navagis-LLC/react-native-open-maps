...
export function createMapLink({ provider = "google", ...params }) {
  ...
  const appleQs = queryString
    .stringify(queryParameters.apple)
    .replace(/%2C/g, ",");
  const googleQs = queryString
    .stringify(queryParameters.google)
    .replace(/%2C/g, ",");
